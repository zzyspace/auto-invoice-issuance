    ...
    for item in stores:
        ...
        configs.append(
            StoreConfig(
                ...
                portal_area=str(item.get("portal_area", item.get("store_area", "xiamen"))),
                portal_area_name=str(item["portal_area_name"])
                if item.get("portal_area_name")
                else str(item["store_area_name"])
